...
class MultiHeadAttention(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.self_attention_heads = nn.ModuleList([Attention(config.n_embd, config.n_head) for _ in range(config.n_head)])
        self.projector = nn.Linear(config.n_embd, config.n_embd)
...
class Block(nn.Module):
    ...
    def forward(self, x, layer_past=None, return_present=False):
        ...
        attn = self.attn(self.ln1(x), layer_past=layer_past)
